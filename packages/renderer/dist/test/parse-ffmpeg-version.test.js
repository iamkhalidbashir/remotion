...
test('Should parse a normal FFFMPEG version', () => {
  ...
  `;
    expect((0, ffmpeg_flags_1.parseFfmpegVersion)(buildconf)).toEqual([4, 3, 1]);
});
test('Should return null if running a git version', () => {
  ...
  `;
    expect((0, ffmpeg_flags_1.parseFfmpegVersion)(buildconf)).toEqual(null);
});
//# sourceMappingURL=parse-ffmpeg-version.test.js.map