...
const TimelineSequence = ({ s, fps }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", Object.assign({ style: style, title: s.displayName }, { children: [(0, jsx_runtime_1.jsx)("div", Object.assign({ style: row }, { children: richTimeline && s.type === 'sequence' ? ((0, jsx_runtime_1.jsx)(Thumbnail_1.Thumbnail, { targetHeight: timeline_layout_1.TIMELINE_LAYER_HEIGHT, targetWidth: thumbnailWidth, composition: video, frameToDisplay: Math.floor(s.from + s.duration / 2) }, void 0)) : null }), void 0), s.type === 'audio' ? ((0, jsx_runtime_1.jsx)(AudioWaveform_1.AudioWaveform, { src: s.src, doesVolumeChange: s.doesVolumeChange, visualizationWidth: width, startFrom: s.startMediaFrom, durationInFrames: s.duration, fps: fps, volume: s.volume, setMaxMediaDuration: setMaxMediaDuration }, void 0)) : null, s.type === 'video' ? (0, jsx_runtime_1.jsx)(TimelineVideoInfo_1.TimelineVideoInfo, { src: s.src }, void 0) : null] }), s.id));
};
exports.TimelineSequence = TimelineSequence;
//# sourceMappingURL=TimelineSequence.js.map