...
const SplitterContainer = ({ orientation, children, defaultFlex, maxFlex, minFlex, id }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(SplitterContext_1.SplitterContext.Provider, Object.assign({ value: value }, { children: (0, jsx_runtime_1.jsx)("div", Object.assign({ ref: ref, style: orientation === 'horizontal' ? containerColumn : containerRow }, { children: children }), void 0) }), void 0));
};
exports.SplitterContainer = SplitterContainer;
//# sourceMappingURL=SplitterContainer.js.map