...
exports.GifForDevelopment = (0, react_1.forwardRef)(({ src, width, height, onError, onLoad, fit = 'fill', ...props }, ref) => {
    ...
    return ((0, jsx_runtime_1.jsx)(tools_1.Canvas, Object.assign({ fit: fit, index: index, frames: state.frames, width: width !== null && width !== void 0 ? width : state.width, height: height !== null && height !== void 0 ? height : state.height }, props, { ref: ref }), void 0));
});
