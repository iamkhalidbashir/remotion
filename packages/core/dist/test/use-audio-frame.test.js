...
test('Media starts at 0 if it is outside a sequence', () => {
    const wrapper = ({ children }) => ((0, jsx_runtime_1.jsx)(sequencing_1.SequenceContext.Provider, Object.assign({ value: null }, { children: children }), void 0));
...
test('Media start is shifted back based on sequence', () => {
    ...
    const wrapper = ({ children }) => ((0, jsx_runtime_1.jsx)(sequencing_1.SequenceContext.Provider, Object.assign({ value: mockSequence }, { children: children }), void 0));
    const { result } = (0, react_hooks_1.renderHook)(() => (0, use_audio_frame_1.useMediaStartsAt)(), { wrapper });
