...
const renderForFrame = (frame, markup) => {
    return (0, react_1.render)((0, jsx_runtime_1.jsx)(timeline_position_state_1.TimelineContext.Provider, Object.assign({ value: {
            rootId: '',
            frame,
            playing: false,
...
test('Basic series test', () => {
    const { queryByText } = renderForFrame(10, (0, jsx_runtime_1.jsxs)(index_1.Series, { children: [(0, jsx_runtime_1.jsx)(index_1.Series.Sequence, Object.assign({ durationInFrames: 5 }, { children: (0, jsx_runtime_1.jsx)(First, {}, void 0) }), void 0), (0, jsx_runtime_1.jsx)(index_1.Series.Sequence, Object.assign({ durationInFrames: 5 }, { children: (0, jsx_runtime_1.jsx)(Second, {}, void 0) }), void 0), (0, jsx_runtime_1.jsx)(index_1.Series.Sequence, Object.assign({ durationInFrames: 5 }, { children: (0, jsx_runtime_1.jsx)(Third, {}, void 0) }), void 0)] }, void 0));
    expect(queryByText(/^third\s0$/g)).not.toBe(null);
});
test('Should support fragments', () => {
    const { queryByText } = renderForFrame(10, (0, jsx_runtime_1.jsxs)(index_1.Series, { children: [(0, jsx_runtime_1.jsx)(index_1.Series.Sequence, Object.assign({ durationInFrames: 5 }, { children: (0, jsx_runtime_1.jsx)(First, {}, void 0) }), void 0), (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(index_1.Series.Sequence, Object.assign({ durationInFrames: 5 }, { children: (0, jsx_runtime_1.jsx)(Second, {}, void 0) }), "0"), (0, jsx_runtime_1.jsx)(index_1.Series.Sequence, Object.assign({ durationInFrames: 5 }, { children: (0, jsx_runtime_1.jsx)(Third, {}, void 0) }), "1")] }, void 0)] }, void 0));
    expect(queryByText(/^third\s0$/g)).not.toBe(null);
});
...
test('Should allow layout prop', () => {
    const { container } = renderForFrame(0, (0, jsx_runtime_1.jsx)(index_1.Series, { children: (0, jsx_runtime_1.jsx)(index_1.Series.Sequence, Object.assign({ durationInFrames: 1 }, { children: (0, jsx_runtime_1.jsx)(First, {}, void 0) }), void 0) }, void 0));
    ...
    const { container: withoutLayoutContainer } = renderForFrame(0, (0, jsx_runtime_1.jsx)(index_1.Series, { children: (0, jsx_runtime_1.jsx)(index_1.Series.Sequence, Object.assign({ durationInFrames: 1, layout: "none" }, { children: (0, jsx_runtime_1.jsx)(First, {}, void 0) }), void 0) }, void 0));
    expect(withoutLayoutContainer.outerHTML).toBe('<div><div>first 0</div></div>');
});
test('Should render nothing after the end', () => {
    const { container } = renderForFrame(10, (0, jsx_runtime_1.jsx)(index_1.Series, { children: (0, jsx_runtime_1.jsx)(index_1.Series.Sequence, Object.assign({ durationInFrames: 1 }, { children: (0, jsx_runtime_1.jsx)(First, {}, void 0) }), void 0) }, void 0));
    expect(container.outerHTML).toBe('<div></div>');
});
test('Should throw if invalid or no duration provided', () => {
    (0, expect_to_throw_1.expectToThrow)(() => {
        renderForFrame(10, (0, jsx_runtime_1.jsx)(index_1.Series, { children: (0, jsx_runtime_1.jsx)(index_1.Series.Sequence, Object.assign({ durationInFrames: NaN }, { children: (0, jsx_runtime_1.jsx)(First, {}, void 0) }), void 0) }, void 0));
...
test('Should allow whitespace', () => {
    const { queryByText } = renderForFrame(11, (0, jsx_runtime_1.jsxs)(index_1.Series, { children: [(0, jsx_runtime_1.jsx)(index_1.Series.Sequence, Object.assign({ durationInFrames: 10 }, { children: (0, jsx_runtime_1.jsx)(First, {}, void 0) }), void 0), ' ', (0, jsx_runtime_1.jsx)(index_1.Series.Sequence, Object.assign({ durationInFrames: 10 }, { children: (0, jsx_runtime_1.jsx)(Second, {}, void 0) }), void 0)] }, void 0));
...
test('Should disallow NaN as offset prop', () => {
    (0, expect_to_throw_1.expectToThrow)(() => {
        renderForFrame(9, (0, jsx_runtime_1.jsx)(index_1.Series, { children: (0, jsx_runtime_1.jsx)(index_1.Series.Sequence, Object.assign({ offset: NaN, layout: "none", durationInFrames: 5 }, { children: (0, jsx_runtime_1.jsx)(Second, {}, void 0) }), void 0) }, void 0));
...
test('Should disallow Infinity as offset prop', () => {
    (0, expect_to_throw_1.expectToThrow)(() => {
        renderForFrame(9, (0, jsx_runtime_1.jsx)(index_1.Series, { children: (0, jsx_runtime_1.jsx)(index_1.Series.Sequence, Object.assign({ offset: Infinity, layout: "none", durationInFrames: 5 }, { children: (0, jsx_runtime_1.jsx)(Second, {}, void 0) }), void 0) }, void 0));
...
test('Should disallow non-integer numbers as offset prop', () => {
    (0, expect_to_throw_1.expectToThrow)(() => {
        renderForFrame(9, (0, jsx_runtime_1.jsx)(index_1.Series, { children: (0, jsx_runtime_1.jsx)(index_1.Series.Sequence, Object.assign({ offset: Math.PI, layout: "none", durationInFrames: 5 }, { children: (0, jsx_runtime_1.jsx)(Second, {}, void 0) }), void 0) }, void 0));
