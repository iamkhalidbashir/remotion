...
describe('Composition-validation render should throw with invalid props', () => {
    describe('Throw with invalid duration props', () => {
        test('It should throw if Sequence has missing duration', () => {
            ...
            // @ts-expect-error
            () => (0, react_1.render)((0, jsx_runtime_1.jsx)(sequencing_1.Sequence, { from: 0 }, void 0)), /You passed to durationInFrames an argument of type undefined, but it must be a number./);
        });
        test('It should throw if Sequence has non-integer durationInFrames', () => {
            (0, expect_to_throw_1.expectToThrow)(() => (0, react_1.render)((0, jsx_runtime_1.jsx)(sequencing_1.Sequence, Object.assign({ from: 0, durationInFrames: 1.1 }, { children: "hi" }), void 0)), /The "durationInFrames" of a sequence must be an integer, but got 1.1./);
        });
    ...
    describe('Throw with invalid from props', () => {
        ...
        test('It should throw if Sequence has non-integer from', () => {
            (0, expect_to_throw_1.expectToThrow)(() => (0, react_1.render)((0, jsx_runtime_1.jsx)(sequencing_1.Sequence, Object.assign({ from: 0.1, durationInFrames: 1 }, { children: "hi" }), void 0)), /The "from" prop of a sequence must be an integer, but got 0.1./);
        });
    });
...
describe('Composition-validation render should NOT throw with valid props', () => {
    test('It should allow null as children', () => {
        expect(() => (0, react_1.render)((0, jsx_runtime_1.jsx)(sequencing_1.Sequence, Object.assign({ durationInFrames: 100, from: 0 }, { children: null }), void 0))).not.toThrow();
    });
    test('It should allow undefined as children', () => {
        expect(() => (0, react_1.render)((0, jsx_runtime_1.jsx)(sequencing_1.Sequence, Object.assign({ durationInFrames: 100, from: 0 }, { children: undefined }), void 0))).not.toThrow();
    });
});
