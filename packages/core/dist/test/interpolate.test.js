...
test('Handle bad types', () => {
    // @ts-expect-error
    expect(() => (0, interpolate_1.interpolate)(undefined, [0, 1], [1, 0])).toThrowError(/input or inputRange or outputRange can not be undefined/);
    // @ts-expect-error
    expect(() => (0, interpolate_1.interpolate)(1, undefined, [1, 0])).toThrowError(/input or inputRange or outputRange can not be undefined/);
    // @ts-expect-error
    expect(() => (0, interpolate_1.interpolate)(1, [1, 0], undefined)).toThrowError(/input or inputRange or outputRange can not be undefined/);
    // @ts-expect-error
    expect(() => (0, interpolate_1.interpolate)(1)).toThrowError(/input or inputRange or outputRange can not be undefined/);
    // @ts-expect-error
    expect(() => (0, interpolate_1.interpolate)('1', [0, 1], [1, 0])).toThrowError(/Cannot interpolation an input which is not a number/);
    // @ts-expect-error
    ...
    // @ts-expect-error
    expect(() => (0, interpolate_1.interpolate)(1, undefined, 'string')).toThrowError(/input or inputRange or outputRange can not be undefined/);
    // @ts-expect-error
    expect(() => (0, interpolate_1.interpolate)([1, 2], undefined, 'string')).toThrowError(/input or inputRange or outputRange can not be undefined/);
});
