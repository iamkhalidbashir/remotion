...
const Row = ({ videoWidth, i, text, zoom }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", Object.assign({ style: {
            ...
            color,
            opacity: 1 - zoom,
        } }, { children: [(0, jsx_runtime_1.jsx)(Label, Object.assign({ outline: true, style: { transform: `scale(${progress})` } }, { children: text }), void 0), (0, jsx_runtime_1.jsx)(Label, Object.assign({ outline: true, style: { transform: `scale(${progress})` } }, { children: text }), void 0), (0, jsx_runtime_1.jsx)(Label, Object.assign({ outline: true, style: { transform: `scale(${progress})` } }, { children: text }), void 0), (0, jsx_runtime_1.jsx)(Label, Object.assign({ outline: true, style: { transform: `scale(${progress})` } }, { children: text }), void 0), (0, jsx_runtime_1.jsx)(Label, Object.assign({ outline: false, style: { transform: `scale(${progress})` } }, { children: text }), void 0), (0, jsx_runtime_1.jsx)(Label, Object.assign({ outline: true, style: { transform: `scale(${progress})` } }, { children: text }), void 0), (0, jsx_runtime_1.jsx)(Label, Object.assign({ outline: true, style: { transform: `scale(${progress})` } }, { children: text }), void 0), (0, jsx_runtime_1.jsx)(Label, Object.assign({ outline: true, style: { transform: `scale(${progress})` } }, { children: text }), void 0), (0, jsx_runtime_1.jsx)(Label, Object.assign({ outline: true, style: { transform: `scale(${progress})` } }, { children: text }), void 0)] }), void 0));
};
