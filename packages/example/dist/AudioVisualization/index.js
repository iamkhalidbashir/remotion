...
const Text = ({ color, transform, blur }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(remotion_1.AbsoluteFill, Object.assign({ style: {
            textAlign: 'center',
            display: 'flex',
            ...
            filter: `blur(${blur}px)`,
                ...
                } }, { children: "Remotion" }), void 0), (0, jsx_runtime_1.jsx)("div", Object.assign({ style: {
                    transform: `translateY(${cool(5) * 8}px)`,
                } }, { children: "Nation" }), void 0)] }), void 0));
};
const AudioVisualization = () => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", Object.assign({ style: { flex: 1 } }, { children: [(0, jsx_runtime_1.jsxs)(remotion_1.AbsoluteFill, { children: [(0, jsx_runtime_1.jsx)(remotion_1.AbsoluteFill, { children: (0, jsx_runtime_1.jsx)(Background, { style: { transform: `scale(${backgroundScale})`, opacity: night }, src: "https://fast-cdn.dynamicwallpaper.club/wallpapers%2Feq8ggec3apr%2Fthumbs%2F800%2F0.jpg?generation=1614257969409557&alt=media" }, void 0) }, void 0), (0, jsx_runtime_1.jsx)(remotion_1.AbsoluteFill, { children: (0, jsx_runtime_1.jsx)(Background, { style: { transform: `scale(${backgroundScale})`, opacity: day }, src: "https://fast-cdn.dynamicwallpaper.club/wallpapers%2Feq8ggec3apr%2Fthumbs%2F800%2F4.jpg?generation=1614257969529252&alt=media" }, void 0) }, void 0)] }, void 0), (0, jsx_runtime_1.jsx)(Blur, {}, void 0), (0, jsx_runtime_1.jsx)(DropDots_1.default, { opacity: night, volume: (0, remotion_1.interpolate)(visualization[1], [0, 0.24], [0, 1], {
                    extrapolateLeft: 'clamp',
                }) }, void 0), (0, jsx_runtime_1.jsx)(remotion_1.Audio, { src: sound1_mp3_1.default }, void 0), (0, jsx_runtime_1.jsxs)(FullSize, { children: [circlesToUse.map((v, i) => {
                    ...
                    }), (0, jsx_runtime_1.jsxs)(Orb, Object.assign({ style: {
                            transform: `scale(${scale})`,
                            backgroundColor: orbBackground,
                            boxShadow: `0 0 50px ${(0, polished_1.transparentize)(0.5, textColor)}`,
                        } }, { children: [(0, jsx_runtime_1.jsx)(Text, { blur: 2, color: "rgba(255, 0, 0, 0.3)", transform: `translateY(${-rgbEffect}px) translateX(${rgbEffect * 2}px)` }, void 0), (0, jsx_runtime_1.jsx)(Text, { blur: 2, color: "rgba(0, 255, 0, 0.3)", transform: `translateX(${rgbEffect * 3}px) translateY(${rgbEffect * 3}px)` }, void 0), (0, jsx_runtime_1.jsx)(Text, { blur: 2, color: "rgba(0, 0, 255, 0.3)", transform: `translateX(${-rgbEffect * 3}px)` }, void 0), (0, jsx_runtime_1.jsx)(Text, { blur: 0, color: textColor, transform: `translateY(${rgbEffect}px)` }, void 0)] }), void 0)] }, void 0)] }), void 0));
};
