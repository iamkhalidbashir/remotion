...
const Arc = ({ progress, rotation, rotateProgress, electronProgress, electronOpacity, }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("svg", Object.assign({ viewBox: `0 0 ${config.width} ${config.height}`, style: {
            position: 'absolute',
            transform: `rotate(${rotation * rotateProgress}deg)`,
            transformOrigin: `${config.width / 2}px ${config.height / 2}px`,
        } }, { children: [(0, jsx_runtime_1.jsx)("defs", { children: (0, jsx_runtime_1.jsxs)("linearGradient", Object.assign({ id: "gradient", x1: "0%", y1: "0%", x2: "0%", y2: "100%" }, { children: [(0, jsx_runtime_1.jsx)("stop", { offset: "0%", stopColor: config_1.COLOR_1 }, void 0), (0, jsx_runtime_1.jsx)("stop", { offset: "100%", stopColor: config_1.COLOR_2 }, void 0)] }), void 0) }, void 0), (0, jsx_runtime_1.jsx)("path", { d: d, fill: "none", stroke: "url(#gradient)", strokeDasharray: arcLength, strokeDashoffset: arcLength - arcLength * progress, strokeLinecap: "round", strokeWidth: 30 }, void 0), (0, jsx_runtime_1.jsx)("circle", { r: electronRadius, fill: "#fff", cx: attributes.x, cy: attributes.y, style: { opacity: electronOpacity } }, void 0), (0, jsx_runtime_1.jsx)("path", { d: `M${leftPointArrow[0]} ${leftPointArrow[1]} ${midPoint[0]} ${midPoint[1]} ${rightPointArrow[0]} ${rightPointArrow[1]} Z`, fill: "white", strokeLinecap: "round", style: { opacity: electronOpacity } }, void 0)] }), void 0));
};
exports.Arc = Arc;
