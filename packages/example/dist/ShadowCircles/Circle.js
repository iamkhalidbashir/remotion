...
const Circle = ({ size }) => {
    ...
    return ((0, jsx_runtime_1.jsx)("svg", Object.assign({ viewBox: `0 0 ${size} ${size}`, width: size, height: size, style: {
            position: 'absolute',
            left: left + amountToMove * x * 0.0003,
            top: top + amountToMove * y * 0.0003,
            WebkitFilter: 'drop-shadow(0 0 5px #5851db)',
        } }, { children: (0, jsx_runtime_1.jsx)("path", { d: makeSquircle(size, size, squircleFactor), fill: color }, void 0) }), void 0));
};
